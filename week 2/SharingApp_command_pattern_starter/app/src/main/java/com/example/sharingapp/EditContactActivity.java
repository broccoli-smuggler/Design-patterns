...
public class EditContactActivity extends AppCompatActivity {
    ...
    public void saveContact(View view) {
        ...
        EditContactCommand edit_command = new EditContactCommand(contact_list, contact, updated_contact, context);
        edit_command.execute();

        if (!edit_command.isExecuted()) return;
    ...
    public void deleteContact(View view) {
        ...
        DeleteContactCommand delete_command = new DeleteContactCommand(contact_list, contact, context);
        delete_command.execute();

        if (!delete_command.isExecuted()) return;
